...
def TukeyToCSV(d, csvName):
    header = ['SNP', 'risk allele', 'population1', 'population2', 'p_value\n']
...
TukeyToCSV(superTukeyResults, 'superPropTestVolc.csv')
TukeyToCSV(subTukeyResults, 'subPropTestVolc.csv')
